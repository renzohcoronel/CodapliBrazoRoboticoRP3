...
@Component
public class ServoPinza {

	protected float max;
	protected float min;
	protected Servo servo;

	public ServoPinza() throws RuntimeIOException {
		PropertiesApp prop = new PropertiesApp();
		this.servo = new Servo(Integer.valueOf(prop.getProperty("servoPinza")), 1.5f);
	...
	public void increase() {
		if (servo.getAngle() < max) {
			...
			System.out.println("SERVO PINZA MAX:" + max + " MIN:" + min + " ACTUAL:" + servo.getAngle());
		} else {
			System.out.println("SERVO PINZA --> TOPE EN MAX:" + max + " ACTUAL:" + servo.getAngle());
		}
	}
	...
	public void decrease() {
		if (servo.getAngle() > min) {
			...
			System.out.println("SERVO PINZA --> TOPE EN MIN:" + min + " ACTUAL:" + servo.getAngle());
		}
	}
